...
class LatinTestCase(HangulizeTestCase):
    ...
    def test_people_roman(self):
        self.assert_examples({
            ...
            u'Apuleius': u'아풀레이우스',
            u'APVLEIVS': u'아풀레이우스',
            u'Gaius Julius Caesar Augustus': u'가이우스 율리우스 카이사르 아우구스투스',
            u'GAIVS IVLIVS CAESAR AVGVSTVS': u'가이우스 율리우스 카이사르 아우구스투스',
            ...
            u'Tiberius Claudius Caesar Augustus Germanicus': u'티베리우스 클라우디우스 카이사르 아우구스투스 게르마니쿠스',
            u'TIBERIVS CLAVDIVS CAESAR AVGVSTVS GERMANICVS': u'티베리우스 클라우디우스 카이사르 아우구스투스 게르마니쿠스',
            u'Lucius Aurelius Commodus Antoninus': u'루키우스 아우렐리우스 콤모두스 안토니누스',
            u'LVCIVS AVRELIVS COMMODVS ANTONINVS': u'루키우스 아우렐리우스 콤모두스 안토니누스',
            u'Flavius Valerius Aurelius Constantinus': u'플라비우스 발레리우스 아우렐리우스 콘스탄티누스',
            u'FLAVIVS VALERIVS AVRELIVS CONSTANTINVS': u'플라비우스 발레리우스 아우렐리우스 콘스탄티누스',
            u'Cornelia Scipionis Africana': u'코르넬리아 스키피오니스 아프리카나',
            u'CORNELIA SCIPIONIS AFRICANA': u'코르넬리아 스키피오니스 아프리카나',
            u'Marcus Licinius Crassus': u'마르쿠스 리키니우스 크라수스',
            u'MARCVS LICINIVS CRASSVS': u'마르쿠스 리키니우스 크라수스',
            u'Gaius Aurelius Valerius Diocletianus': u'가이우스 아우렐리우스 발레리우스 디오클레티아누스',
            u'GAIVS AVRELIVS VALERIVS DIOCLETIANVS': u'가이우스 아우렐리우스 발레리우스 디오클레티아누스',
            ...
            u'Flavius Petrus Sabbatius Justinianus': u'플라비우스 페트루스 사바티우스 유스티니아누스',
            u'FLAVIVS PETRVS SABBATIVS IVSTINIANVS': u'플라비우스 페트루스 사바티우스 유스티니아누스',
            u'Titus Livius': u'티투스 리비우스',
            u'TITVS LIVIVS': u'티투스 리비우스',
            u'Gaius Marius': u'가이우스 마리우스',
            u'GAIVS MARIVS': u'가이우스 마리우스',
            u'Nero Claudius Caesar Augustus Germanicus': u'네로 클라우디우스 카이사르 아우구스투스 게르마니쿠스',
            u'NERO CLAVDIVS CAESAR AVGVSTVS GERMANICVS': u'네로 클라우디우스 카이사르 아우구스투스 게르마니쿠스',
            ...
            u'Gaius Plinius Caecilius Secundus': u'가이우스 플리니우스 카이킬리우스 세쿤두스',
            u'GAIVS PLINIVS CAECILIVS SECVNDVS': u'가이우스 플리니우스 카이킬리우스 세쿤두스',
            u'Gnaeus Pompeius Magnus': u'그나이우스 폼페이우스 마그누스',
            u'GNAEVS POMPEIVS MAGNVS': u'그나이우스 폼페이우스 마그누스',
            u'Sextus Aurelius Propertius': u'섹스투스 아우렐리우스 프로페르티우스',
            u'SEXTVS AVRELIVS PROPERTIVS': u'섹스투스 아우렐리우스 프로페르티우스',
            ...
            u'Lucius Cornelius Sulla Felix': u'루키우스 코르넬리우스 술라 펠릭스',
            u'LVCIVS CORNELIVS SVLLA FELIX': u'루키우스 코르넬리우스 술라 펠릭스',
            u'Publius Cornelius Tacitus': u'푸블리우스 코르넬리우스 타키투스',
            u'PVBLIVS CORNELIVS TACITVS': u'푸블리우스 코르넬리우스 타키투스',
            u'Marcus Ulpius Nerva Trajanus': u'마르쿠스 울피우스 네르바 트라야누스',
            u'MARCUS VLPIVS NERVA TRAIANVS': u'마르쿠스 울피우스 네르바 트라야누스',
    ...
    def test_people_nonroman(self):
        self.assert_examples({
            ...
            u'Anselmus': u'안셀무스',
            u'Averroës': u'아베로에스',
            u'Aurelius Augustinus Hipponensis': u'아우렐리우스 아우구스티누스 히포넨시스',
    ...
    def test_texts(self):
        self.assert_examples({
            ...
            u'Philosophiæ Naturalis Principia Mathematica': u'필로소피아이 나투랄리스 프링키피아 마테마티카',
        })
